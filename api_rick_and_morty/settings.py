"""
Django settings for api_rick_and_morty project.
...
ROOT_URLCONF = "api_rick_and_morty.urls"
...
WSGI_APPLICATION = "api_rick_and_morty.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API provides access to data about the characters of the Rick and Morty series",
    "VERSION": "1.0.0",
